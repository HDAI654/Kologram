...
export default function Home() {
  ...
  return (
    <div style={{ marginTop: "90px", marginBottom: "90px" }}>
      ...
      {/* Navbars */}
      <HomeNavbar screenMode={screenMode} isLogin={isLogin} username={username.current} />
            ...
            <div className="row align-items-center">
              ...
              <div className="col-md-6">
                <div className="d-flex justify-content-center justify-content-md-end align-items-center gap-3 flex-wrap">
                  ...
                  {/* Telegram */}
                  <a className="text-dark" href="https://t.me/yourtelegram" target="_blank" rel="noopener noreferrer" aria-label="Telegram">
                    <i className="fab fa-telegram fa-lg"></i>
                  </a>

                  {/* Facebook */}
                  <a className="text-dark" href="https://facebook.com/yourpage" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                    <i className="fab fa-facebook fa-lg"></i>
                  </a>

                  {/* GitHub */}
                  <a className="text-dark" href="https://github.com/HDAI654" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                    <i className="fab fa-github fa-lg"></i>
                  </a>

                  {/* Gmail */}
                  <a className="text-dark d-flex align-items-center gap-1" href="mailto:hdai.code@gmail.com" aria-label="Gmail">
