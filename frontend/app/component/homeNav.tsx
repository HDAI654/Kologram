...
function HomeNavbar({ screenMode, isLogin, username="Guest", setSearchValue }:{screenMode:string, isLogin:boolean, username:string, setSearchValue:React.Dispatch<React.SetStateAction<string>>}) {
